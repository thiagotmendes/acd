...
if(!is_admin()){
	...
	wp_enqueue_style( 'fontawesome', get_template_directory_uri().'/css/font-awesome.css', array(),'3.3.6', 'screen' );
	wp_enqueue_style( 'blog', get_template_directory_uri().'/css/blog.css', array(),'4.5.0', 'screen' );
